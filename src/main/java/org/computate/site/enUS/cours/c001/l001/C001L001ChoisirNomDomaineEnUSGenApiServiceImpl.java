...
public class C001L001ChoisirNomDomaineEnUSGenApiServiceImpl implements C001L001ChoisirNomDomaineEnUSGenApiService {
	...
	public void rechercheC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L001ChoisirNomDomaine>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomCanonique_indexed_string:" + ClientUtils.escapeQueryChars("org.computate.site.enUS.cours.c001.l001.C001L001ChoisirNomDomaine"));
