...
public class CoursEnUSGenApiServiceImpl implements CoursEnUSGenApiService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CoursEnUSGenApiServiceImpl.class);

	private static final String SERVICE_ADDRESS = "CoursEnUSApiServiceImpl";
