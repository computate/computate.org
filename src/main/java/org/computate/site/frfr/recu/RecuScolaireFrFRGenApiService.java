...
public interface RecuScolaireFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate.org-frFR-RecuScolaire").register(RecuScolaireFrFRGenApiService.class, new RecuScolaireFrFRApiServiceImpl(siteContexte));
	}
