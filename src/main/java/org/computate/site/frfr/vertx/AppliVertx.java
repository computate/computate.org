...
import org.computate.site.frfr.java.LocalDateSerializer;
import org.computate.site.frfr.java.LocalTimeSerializer;
import org.computate.site.frfr.java.ZonedDateTimeSerializer;
...
/**
 * NomCanonique.enUS: org.computate.site.enus.vertx.AppVertx
...
//						usineRouteur.addSecurityHandler("openIdConnect", gestionnaireAuth);
	...
	private Promise<Void> demarrerServeur() {
		...
		if("site.computate.org".equals(configSite.getSiteNomHote())) {
			...
			gestionnaireStatic.setWebRoot("/usr/local/src/computate.org-static");
		}
		...
		LOGGER.info(String.format(demarrerServeurAvantServeur, (ssl ? "https" : "http"), siteNomHote, sitePort));
