...
public class CoursEnUSGenPage extends CoursEnUSGenPageGen<MiseEnPage> {
	...
	@Override public void htmlScriptsCoursEnUSGenPage() {
		e("script").a("src", statiqueUrlBase, "/js/frFR/CoursEnUSPage.js").f().g("script");
	}
	...
	public void table1CoursEnUSGenPage() {
		{ e("table").a("class", "w3-table w3-bordered w3-striped w3-border w3-hoverable ").f();
			table2CoursEnUSGenPage();
		} g("table");
	}

	public void table2CoursEnUSGenPage() {
		thead1CoursEnUSGenPage();
		tbody1CoursEnUSGenPage();
		tfoot1CoursEnUSGenPage();
	}

	public void thead1CoursEnUSGenPage() {
		{ e("thead").a("class", "w3-green w3-hover-green ").f();
			thead2CoursEnUSGenPage();
		} g("thead");
	}

	public void thead2CoursEnUSGenPage() {
			{ e("tr").f();
			if(getColonneCree()) {
				e("th").f().sx("crée").g("th");
			}
	...
	public void tbody1CoursEnUSGenPage() {
		{ e("tbody").f();
			tbody2CoursEnUSGenPage();
		} g("tbody");
	}

	public void tbody2CoursEnUSGenPage() {
	...
	public void tfoot1CoursEnUSGenPage() {
		{ e("tfoot").a("class", "w3-green w3-hover-green ").f();
			tfoot2CoursEnUSGenPage();
		} g("tfoot");
	}

	public void tfoot2CoursEnUSGenPage() {
		{ e("tr").f();
	...
	public void htmlBodyFormsCoursEnUSGenPage() {
			...
			if(listeCours != null && listeCours.size() == 1) {
				{ e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-green ")
						.a("id", "rechargerCeCoursEnUSGenPage")
						.a("onclick", "patchCoursVals( [ {name: 'fq', value: 'pk:' + " + requeteSite_.getRequetePk() + " } ], {}, function() { ajouterLueur($('#rechargerCeCoursEnUSGenPage')); }, function() { ajouterErreur($('#rechargerCeCoursEnUSGenPage')); }); return false; ").f();
		...
		htmlSuggereCoursEnUSGenPage(this, null, listeCours);
	}

	/**
	**/
	public static void htmlSuggereCoursEnUSGenPage(MiseEnPage p, String id, ListeRecherche<Cours> listeCours) {
		...
		try {
			...
			if(
					CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), CoursEnUSGenPage.ROLES)
					|| CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRoyaume(), CoursEnUSGenPage.ROLES)
					) {
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "rechargerTousCoursEnUSGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-green ").a("onclick", "patchCoursVals([], {}, function() { ajouterLueur($('#rechargerTousCoursEnUSGenPage", id, "')); }, function() { ajouterErreur($('#rechargerTousCoursEnUSGenPage", id, "')); }); ").f();
