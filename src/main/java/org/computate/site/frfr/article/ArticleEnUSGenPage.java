...
public class ArticleEnUSGenPage extends ArticleEnUSGenPageGen<MiseEnPage> {
	...
	@Override public void htmlScriptsArticleEnUSGenPage() {
		e("script").a("src", statiqueUrlBase, "/js/frFR/ArticleEnUSPage.js").f().g("script");
	}
	...
	public void table1ArticleEnUSGenPage() {
		{ e("table").a("class", "w3-table w3-bordered w3-striped w3-border w3-hoverable ").f();
			table2ArticleEnUSGenPage();
		} g("table");
	}

	public void table2ArticleEnUSGenPage() {
		thead1ArticleEnUSGenPage();
		tbody1ArticleEnUSGenPage();
		tfoot1ArticleEnUSGenPage();
	}

	public void thead1ArticleEnUSGenPage() {
		{ e("thead").a("class", "w3-green w3-hover-green ").f();
			thead2ArticleEnUSGenPage();
		} g("thead");
	}

	public void thead2ArticleEnUSGenPage() {
			{ e("tr").f();
			if(getColonneCree()) {
				e("th").f().sx("crée").g("th");
			}
	...
	public void tbody1ArticleEnUSGenPage() {
		{ e("tbody").f();
			tbody2ArticleEnUSGenPage();
		} g("tbody");
	}

	public void tbody2ArticleEnUSGenPage() {
	...
	public void tfoot1ArticleEnUSGenPage() {
		{ e("tfoot").a("class", "w3-green w3-hover-green ").f();
			tfoot2ArticleEnUSGenPage();
		} g("tfoot");
	}

	public void tfoot2ArticleEnUSGenPage() {
		{ e("tr").f();
	...
	public void htmlBodyFormsArticleEnUSGenPage() {
			...
			if(listeArticle != null && listeArticle.size() == 1) {
				{ e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-green ")
						.a("id", "rechargerCeArticleEnUSGenPage")
						.a("onclick", "patchArticleVals( [ {name: 'fq', value: 'pk:' + " + requeteSite_.getRequetePk() + " } ], {}, function() { ajouterLueur($('#rechargerCeArticleEnUSGenPage')); }, function() { ajouterErreur($('#rechargerCeArticleEnUSGenPage')); }); return false; ").f();
		...
		htmlSuggereArticleEnUSGenPage(this, null, listeArticle);
	}

	/**
	**/
	public static void htmlSuggereArticleEnUSGenPage(MiseEnPage p, String id, ListeRecherche<Article> listeArticle) {
		...
		try {
			...
			if(
					CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), ArticleEnUSGenPage.ROLES)
					|| CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRoyaume(), ArticleEnUSGenPage.ROLES)
					) {
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "rechargerTousArticleEnUSGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-green ").a("onclick", "patchArticleVals([], {}, function() { ajouterLueur($('#rechargerTousArticleEnUSGenPage", id, "')); }, function() { ajouterErreur($('#rechargerTousArticleEnUSGenPage", id, "')); }); ").f();
