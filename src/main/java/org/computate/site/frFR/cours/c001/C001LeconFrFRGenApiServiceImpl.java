...
public class C001LeconFrFRGenApiServiceImpl implements C001LeconFrFRGenApiService {
	...
	public C001LeconFrFRGenApiServiceImpl(SiteContexteFrFR siteContexte) {
		this.siteContexte = siteContexte;
		C001LeconFrFRGenApiService service = C001LeconFrFRGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void recherchefrfrpageC001Lecon(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourC001Lecon(siteContexte, operationRequete);
	...
	public void reponse200RechercheFrFRPageC001Lecon(ListeRecherche<C001Lecon> listeC001Lecon, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			RequeteSiteFrFR requeteSite = listeC001Lecon.getRequeteSite_();
	...
	public void erreurC001Lecon(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001Lecon(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001Lecon(SiteContexteFrFR siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteFrFRPourC001Lecon(siteContexte, operationRequete, null);
	}

	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001Lecon(SiteContexteFrFR siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001Lecon(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001Lecon(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001Lecon>>> gestionnaireEvenements) {
		try {
