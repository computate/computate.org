...
public class C001L001ChoisirNomDomaineFrFRGenApiServiceImpl implements C001L001ChoisirNomDomaineFrFRGenApiService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(C001L001ChoisirNomDomaineFrFRGenApiServiceImpl.class);

	private static final String SERVICE_ADDRESS = "C001L001ChoisirNomDomaineFrFRApiServiceImpl";
