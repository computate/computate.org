 ...
 * Traduire: false
 **/
public class C001L008InstallerKeycloakFrFRGenPage extends C001L008InstallerKeycloakFrFRGenPageGen<C001LeconFrFRPage> {
	...
	@Override protected void _pageUri(Couverture<String> c) {
		c.o("/frFR/cours/001/008-comment-installer-la-derniere-version-de-postgresql");
	}

	@Override protected void _pageUriEnUS(Couverture<String> c) {
		c.o("/enUS/course/001/008-how-to-install-the-latest-version-of-postgresql");
	}
	...
	@Override protected void _pageImageUri(Couverture<String> c) {
			c.o("/png/frFR/cours/001/008-comment-installer-la-derniere-version-de-postgresql-999.png");
	}
	...
	@Override public void initLoinC001L008InstallerKeycloakFrFRGenPage() {
		initC001L008InstallerKeycloakFrFRGenPage();
		super.initLoinMiseEnPage();
	}

	@Override public void htmlScriptsC001L008InstallerKeycloakFrFRGenPage() {
		e("script").a("src", "/static/js/C001L008InstallerKeycloakFrFRGenPage.js").f().g("script");
	}


	@Override public void htmlBodyC001L008InstallerKeycloakFrFRGenPage() {
	...
	@Override public void htmlBodyCourtC001L008InstallerKeycloakFrFRGenPage() {
