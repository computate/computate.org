 ...
 * Traduire: false
 **/
public class C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiServiceImpl implements C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiService {

	protected static final Logger LOGGER = LoggerFactory.getLogger(C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001L003InstallerMachineVirtuelleVirtualBoxFrFRApiServiceImpl";

	protected SiteContexteFrFR siteContexte;

	public C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiServiceImpl(SiteContexteFrFR siteContexte) {
		this.siteContexte = siteContexte;
		C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiService service = C001L003InstallerMachineVirtuelleVirtualBoxFrFRGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void recherchefrfrpageC001L003InstallerMachineVirtuelleVirtualBoxId(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		recherchefrfrpageC001L003InstallerMachineVirtuelleVirtualBox(operationRequete, gestionnaireEvenements);
	}
	...
	public void recherchefrfrpageC001L003InstallerMachineVirtuelleVirtualBox(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourC001L003InstallerMachineVirtuelleVirtualBox(siteContexte, operationRequete);
			sqlC001L003InstallerMachineVirtuelleVirtualBox(requeteSite, a -> {
				if(a.succeeded()) {
					utilisateurC001L003InstallerMachineVirtuelleVirtualBox(requeteSite, b -> {
						if(b.succeeded()) {
							rechercheC001L003InstallerMachineVirtuelleVirtualBox(requeteSite, false, true, "/frFR/cours/001/003-essayer-linux-sur-une-machine-virtuelle-avec-virtual-box", c -> {
								if(c.succeeded()) {
									ListeRecherche<C001L003InstallerMachineVirtuelleVirtualBox> listeC001L003InstallerMachineVirtuelleVirtualBox = c.result();
									reponse200RechercheFrFRPageC001L003InstallerMachineVirtuelleVirtualBox(listeC001L003InstallerMachineVirtuelleVirtualBox, d -> {
										if(d.succeeded()) {
	...
	public void reponse200RechercheFrFRPageC001L003InstallerMachineVirtuelleVirtualBox(ListeRecherche<C001L003InstallerMachineVirtuelleVirtualBox> listeC001L003InstallerMachineVirtuelleVirtualBox, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			Buffer buffer = Buffer.buffer();
			RequeteSiteFrFR requeteSite = listeC001L003InstallerMachineVirtuelleVirtualBox.getRequeteSite_();
			ToutEcrivain w = ToutEcrivain.creer(listeC001L003InstallerMachineVirtuelleVirtualBox.getRequeteSite_(), buffer);
			requeteSite.setW(w);
			C001L003InstallerMachineVirtuelleVirtualBoxFrFRPage page = new C001L003InstallerMachineVirtuelleVirtualBoxFrFRPage();
			SolrDocument pageDocumentSolr = new SolrDocument();

			pageDocumentSolr.setField("pageUri_frFR_stored_string", "/frFR/cours/001/003-essayer-linux-sur-une-machine-virtuelle-avec-virtual-box");
			page.setPageDocumentSolr(pageDocumentSolr);
			page.setW(w);
			page.initLoinC001L003InstallerMachineVirtuelleVirtualBoxFrFRPage(requeteSite);
			page.html();
	...
	public void erreurC001L003InstallerMachineVirtuelleVirtualBox(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001L003InstallerMachineVirtuelleVirtualBox(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001L003InstallerMachineVirtuelleVirtualBox(SiteContexteFrFR siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteFrFRPourC001L003InstallerMachineVirtuelleVirtualBox(siteContexte, operationRequete, null);
	}

	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001L003InstallerMachineVirtuelleVirtualBox(SiteContexteFrFR siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001L003InstallerMachineVirtuelleVirtualBox(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001L003InstallerMachineVirtuelleVirtualBox(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L003InstallerMachineVirtuelleVirtualBox>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.frFR.cours.c001.l003.C001L003InstallerMachineVirtuelleVirtualBox"));
