 ...
 * Traduire: false
 **/
public class C001FrFRGenApiServiceImpl implements C001FrFRGenApiService {

	protected static final Logger LOGGER = LoggerFactory.getLogger(C001FrFRGenApiServiceImpl.class);

	protected static final String SERVICE_ADDRESS = "C001FrFRApiServiceImpl";

	protected SiteContexteFrFR siteContexte;

	public C001FrFRGenApiServiceImpl(SiteContexteFrFR siteContexte) {
		this.siteContexte = siteContexte;
		C001FrFRGenApiService service = C001FrFRGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void recherchefrfrpageC001(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourC001(siteContexte, operationRequete);
	...
	public void reponse200RechercheFrFRPageC001(ListeRecherche<C001> listeC001, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			RequeteSiteFrFR requeteSite = listeC001.getRequeteSite_();
	...
	public void reponse200RechercheC001(ListeRecherche<C001> listeC001, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			for(int i = 0; i < listeC001.size(); i++) {
				...
				entiteValeur = o.getSiteNomDomaine();
				if(entiteValeur != null)
					w.tl(3, entiteNumero++ == 0 ? "" : ", ", "\"siteNomDomaine\": ", w.qjs(entiteValeur));
	...
	public void postC001(JsonObject body, OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourC001(siteContexte, operationRequete, body);
			sqlC001(requeteSite, a -> {
				if(a.succeeded()) {
	...
	public void creerPOSTC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<C001>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public Future<C001> sqlPATCHC001(C001 o) {
		...
		try {
			...
			patchSqlParams.addAll(Arrays.asList(pk, "org.computate.site.frFR.cours.c001.C001"));
	...
	public void supprimerDELETEC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
			String utilisateurId = requeteSite.getUtilisateurId();
	...
	public void reponse200DELETEC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			Buffer buffer = Buffer.buffer();
	...
	public void erreurC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001(SiteContexteFrFR siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteFrFRPourC001(siteContexte, operationRequete, null);
	}

	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001(SiteContexteFrFR siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
			String utilisateurId = requeteSite.getUtilisateurId();
	...
	public void rechercheC001(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001>>> gestionnaireEvenements) {
		try {
