 ...
 * Traduire: false
 **/
public class C001L002ChoisirOrdinateurFrFRGenApiServiceImpl implements C001L002ChoisirOrdinateurFrFRGenApiService {

	private static final Logger LOGGER = LoggerFactory.getLogger(C001L002ChoisirOrdinateurFrFRGenApiServiceImpl.class);

	private static final String SERVICE_ADDRESS = "C001L002ChoisirOrdinateurFrFRApiServiceImpl";

	protected SiteContexteFrFR siteContexte;

	public C001L002ChoisirOrdinateurFrFRGenApiServiceImpl(SiteContexteFrFR siteContexte) {
		this.siteContexte = siteContexte;
		C001L002ChoisirOrdinateurFrFRGenApiService service = C001L002ChoisirOrdinateurFrFRGenApiService.creerProxy(siteContexte.getVertx(), SERVICE_ADDRESS);
	}
	...
	public void recherchefrfrpageC001L002ChoisirOrdinateurId(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		recherchefrfrpageC001L002ChoisirOrdinateur(operationRequete, gestionnaireEvenements);
	}
	...
	public void recherchefrfrpageC001L002ChoisirOrdinateur(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourC001L002ChoisirOrdinateur(siteContexte, operationRequete);
			sqlC001L002ChoisirOrdinateur(requeteSite, a -> {
				if(a.succeeded()) {
					utilisateurC001L002ChoisirOrdinateur(requeteSite, b -> {
						if(b.succeeded()) {
							rechercheC001L002ChoisirOrdinateur(requeteSite, false, true, "/frFR/cours/001/002-choisir-ordinateur", c -> {
								if(c.succeeded()) {
									ListeRecherche<C001L002ChoisirOrdinateur> listeC001L002ChoisirOrdinateur = c.result();
									reponse200RechercheFrFRPageC001L002ChoisirOrdinateur(listeC001L002ChoisirOrdinateur, d -> {
										if(d.succeeded()) {
	...
	public void reponse200RechercheFrFRPageC001L002ChoisirOrdinateur(ListeRecherche<C001L002ChoisirOrdinateur> listeC001L002ChoisirOrdinateur, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			Buffer buffer = Buffer.buffer();
			RequeteSiteFrFR requeteSite = listeC001L002ChoisirOrdinateur.getRequeteSite_();
			ToutEcrivain w = ToutEcrivain.creer(listeC001L002ChoisirOrdinateur.getRequeteSite_(), buffer);
			requeteSite.setW(w);
			C001L002ChoisirOrdinateurFrFRPage page = new C001L002ChoisirOrdinateurFrFRPage();
			SolrDocument pageDocumentSolr = new SolrDocument();

			pageDocumentSolr.setField("pageUri_frFR_stored_string", "/frFR/cours/001/002-choisir-ordinateur");
			page.setPageDocumentSolr(pageDocumentSolr);
			page.setW(w);
			page.initLoinC001L002ChoisirOrdinateurFrFRPage(requeteSite);
			page.html();
	...
	public void erreurC001L002ChoisirOrdinateur(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements, AsyncResult<?> resultatAsync) {
	...
	public void sqlC001L002ChoisirOrdinateur(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
	...
	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001L002ChoisirOrdinateur(SiteContexteFrFR siteContexte, OperationRequest operationRequete) {
		return genererRequeteSiteFrFRPourC001L002ChoisirOrdinateur(siteContexte, operationRequete, null);
	}

	public RequeteSiteFrFR genererRequeteSiteFrFRPourC001L002ChoisirOrdinateur(SiteContexteFrFR siteContexte, OperationRequest operationRequete, JsonObject body) {
	...
	public void utilisateurC001L002ChoisirOrdinateur(RequeteSiteFrFR requeteSite, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			SQLConnection connexionSql = requeteSite.getConnexionSql();
	...
	public void rechercheC001L002ChoisirOrdinateur(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L002ChoisirOrdinateur>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomsCanoniques_indexed_strings:" + ClientUtils.escapeQueryChars("org.computate.site.frFR.cours.c001.l002.C001L002ChoisirOrdinateur"));
