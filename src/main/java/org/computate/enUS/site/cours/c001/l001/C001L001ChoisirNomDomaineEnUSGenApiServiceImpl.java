...
import org.computate.enUS.site.cours.c001.l001.C001L001ChoisirNomDomaineEnUSPage;
...
public class C001L001ChoisirNomDomaineEnUSGenApiServiceImpl implements C001L001ChoisirNomDomaineEnUSGenApiService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(C001L001ChoisirNomDomaineEnUSGenApiServiceImpl.class);

	private static final String SERVICE_ADDRESS = "C001L001ChoisirNomDomaineEnUSApiServiceImpl";
	...
	public void rechercheC001L001ChoisirNomDomaine(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001L001ChoisirNomDomaine>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomCanonique_indexed_string:" + ClientUtils.escapeQueryChars("org.computate.enUS.site.cours.c001.l001.C001L001ChoisirNomDomaine"));
