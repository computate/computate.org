...
public class C001EnUSGenApiServiceImpl implements C001EnUSGenApiService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(C001EnUSGenApiServiceImpl.class);

	private static final String SERVICE_ADDRESS = "C001EnUSApiServiceImpl";
	...
	public void rechercheC001(RequeteSiteEnUS requeteSite, Boolean peupler, Boolean stocker, String classeApiUriMethode, Handler<AsyncResult<ListeRecherche<C001>>> gestionnaireEvenements) {
		try {
			...
			listeRecherche.addFilterQuery("classeNomCanonique_indexed_string:" + ClientUtils.escapeQueryChars("org.computate.enUS.site.cours.c001.C001"));
