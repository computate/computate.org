...
public interface C001L001ChoisirNomDomaineEnUSGenApiService {
	...
	static void enregistrerService(SiteContexteEnUS siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("C001L001ChoisirNomDomaine").register(C001L001ChoisirNomDomaineEnUSGenApiService.class, new C001L001ChoisirNomDomaineEnUSApiServiceImpl(siteContexte));
	}
