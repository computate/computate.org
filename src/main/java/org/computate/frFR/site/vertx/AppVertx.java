...
import org.computate.frFR.site.cours.CoursApiServiceImpl;
import org.computate.frFR.site.cours.CoursGenApiService;
import org.computate.frFR.site.cours.c001.C001ApiServiceImpl;
import org.computate.frFR.site.cours.c001.C001GenApiService;
import org.computate.frFR.site.cours.c001.C001LeconApiServiceImpl;
import org.computate.frFR.site.cours.c001.C001LeconGenApiService;
import org.computate.frFR.site.cours.c001.l001.C001L001ChoisirNomDomaineApiServiceImpl;
import org.computate.frFR.site.cours.c001.l001.C001L001ChoisirNomDomaineGenApiService;
...
//				gestionnaireAuth.extraParams(new JsonObject().put("scope", "openid").put("login", true));
	...
	public AppVertx setupCallback(SiteContexte siteContexte, String callbackPath) {
	...
	private Future<Void> demarrerServeur(SiteContexte siteContexte) {
		...
		new ServiceBinder(vertx).setAddress("C001").register(C001GenApiService.class, new C001ApiServiceImpl(siteContexte));
