...
public interface C001L001ChoisirNomDomaineFrFRGenApiService {
	...
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("C001L001ChoisirNomDomaine").register(C001L001ChoisirNomDomaineFrFRGenApiService.class, new C001L001ChoisirNomDomaineFrFRApiServiceImpl(siteContexte));
	}
