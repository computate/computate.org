...
public class  extends AbstractVerticle {
...
//		OpenAPI3RouterFactory.create(vertx, "src/main/resources/openapi3.yaml", ar -> {
	...
	public  setupCallback(SiteContexte siteContexte, String callbackPath) {
	...
	@Override()
	public void  start(Future<Void> demarrerFuture) throws Exception, Exception {
