...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.enUS.site.cours.c001.C001&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class C001Gen<DEV> extends Cours {
	...
	public C001 initLoinC001(RequeteSite requeteSite_) {
	...
	public void requeteSiteC001(RequeteSite requeteSite_) {
