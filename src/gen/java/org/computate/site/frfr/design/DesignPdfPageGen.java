...
import org.computate.site.frfr.design.DesignPdfGenPage;
...
/**	
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frfr.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr. </a>
 * <br/>
 **/
public abstract class DesignPdfPageGen<DEV> extends DesignPdfGenPage {
	...
	@Override public void htmlBodyCourt() {
		htmlBodyCourtDesignPdfPage();
		super.htmlBodyCourt();
	}

	public void htmlBodyCourtDesignPdfPage() {
	}
