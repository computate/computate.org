...
import org.computate.site.frfr.design.DesignMailGenPage;
...
/**	
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frfr.design.DesignMailPage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr. </a>
 * <br/>
 **/
public abstract class DesignMailPageGen<DEV> extends DesignMailGenPage {
	...
	@Override public void htmlBodyCourt() {
		htmlBodyCourtDesignMailPage();
		super.htmlBodyCourt();
	}

	public void htmlBodyCourtDesignMailPage() {
	}
