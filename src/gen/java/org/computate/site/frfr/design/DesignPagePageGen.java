...
import org.computate.site.frfr.design.DesignPageGenPage;
...
/**	
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frfr.design.DesignPagePage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr. </a>
 * <br/>
 **/
public abstract class DesignPagePageGen<DEV> extends DesignPageGenPage {
	...
	@Override public void htmlBodyCourt() {
		htmlBodyCourtDesignPagePage();
		super.htmlBodyCourt();
	}

	public void htmlBodyCourtDesignPagePage() {
	}
