...
import org.computate.site.frfr.cluster.ClusterGenPage;
...
/**	
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frfr.cluster.ClusterPage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr. </a>
 * <br/>
 **/
public abstract class ClusterPageGen<DEV> extends ClusterGenPage {
	...
	@Override public void htmlBodyCourt() {
		htmlBodyCourtClusterPage();
		super.htmlBodyCourt();
	}

	public void htmlBodyCourtClusterPage() {
	}
