...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true">Trouver la classe recapituler3 dans Solr</a>
 * <br/>
 **/
public abstract class C001L010InstallerSolrGen<DEV> extends C001Lecon {

	public static final String C001L010InstallerSolr_UnNom = "le leçon";
	public static final String C001L010InstallerSolr_NomSingulier = "leçon";
	public static final String C001L010InstallerSolr_NomPluriel = "leçons";
	public static final String C001L010InstallerSolr_H1 = "Comment puis-je essayer un moteur de recherche dans mon projet ? ";
	public static final String C001L010InstallerSolr_H2 = "Installer Solr à partir du code source. ";
	public static final String C001L010InstallerSolr_Titre = "Comment puis-je essayer un moteur de recherche dans mon projet ? Installer Solr à partir du code source. ";
	public static final String C001L010InstallerSolr_LesNoms = "les leçons";
	public static final String C001L010InstallerSolr_NomVar = "leçon";
	 ...
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:zookeeperPortClient">Trouver l'entité zookeeperPortClient dans Solr</a>
	 * <br/>
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:solrVersion">Trouver l'entité solrVersion dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:solrPortClient">Trouver l'entité solrPortClient dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	/**	<br/>L'entité « solrTag »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:solrTag">Trouver l'entité solrTag dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:solrConfigset">Trouver l'entité solrConfigset dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:solrCollection">Trouver l'entité solrCollection dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	public static final String moiP2 = "Les bases de données et les moteurs de recherche sont des ressources précieuses pour la gestion des données de différentes manières. ";
	public static final String moiP3 = "Les bases de données sont idéales pour les données utilisateur persistantes et normalisées. ";
	public static final String moiP4 = "Les moteurs de recherche sont parfaits pour les versions transformées, dénormalisées et interrogeables des données. ";
	public static final String moiP5 = "Index rapides, mise en surbrillance des requêtes, pagination, filtres et facettisation ne sont que quelques-unes des fonctionnalités essentielles que vous pouvez ajouter à votre site avec un moteur de recherche. ";
	public static final String moiP6 = "Je vous aiderai à installer une version récente de Solr pour ajouter la recherche à votre site Web de manière open source. ";
	...
	/**	<br/>L'entité « moi »
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:moi">Trouver l'entité moi dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:personnaliser">Trouver l'entité personnaliser dans Solr</a>
	 * <br/>
	...
	public static final String questionDependencesH3Span1 = "Comment installer les dépendences pour Solr ? ";
	...
	public static final String questionDependencesOl2Li5Dd1 = " : Les noms de paquets des dépendances pour la construction de Solr à partir du code source. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionDependences">Trouver l'entité questionDependences dans Solr</a>
	 * <br/>
	...
	public static final String questionMkdirSrcH3Span1 = "Où est-ce que je place le code source Solr ? ";
	...
	public static final String questionMkdirSrcH4Span1 = "Créez un répertoire solr dans /usr/local/src. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionMkdirSrc">Trouver l'entité questionMkdirSrc dans Solr</a>
	 * <br/>
	...
	public static final String questionClonerSourceH3Span1 = "Comment télécharger le code source de Solr ? ";
	...
	public static final String questionClonerSourceOl2Li31 = "https://github.com/apache/lucene-solr.git : URL git vers le référentiel de code source Solr. ";
	public static final String questionClonerSourceOl2Li3 = questionClonerSourceOl2Li31;
	public static final String questionClonerSourceOl2Li41 = "/usr/local/src/solr : Répertoire dans lequel le code source Solr sera cloné. ";
	...
	public static final String questionClonerSourceP21 = "Solr a un dépôt git énorme avec beaucoup d’histoire et peut être lent à cloner. ";
	...
	public static final String questionClonerSourceP23 = "La version 7.1.0 est une branche récente qui ne nécessite pas de nouvelle version de ant. ";
	public static final String questionClonerSourceP24 = "L'installation d'une version supérieure à 7.1.0 est plus difficile et je vous recommande d'attendre une mise à jour du système d'exploitation avec la version ant 1.10. *. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionClonerSource">Trouver l'entité questionClonerSource dans Solr</a>
	 * <br/>
	...
	public static final String questionConstruireSourceH3Span1 = "Comment contruire le code source de Solr ? ";
	...
	public static final String questionConstruireSourceH4Span1 = "Construisez Solr avec la commande ant. ";
	...
	public static final String questionConstruireSourceOl1Li051 = "ivy-bootstrap) : Installez une copie d'Ivy dans votre bibliothèque utilisateur Ant. ";
	...
	public static final String questionConstruireSourceOl2Li051 = "package) : Construisez Solr à partir du code source. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionConstruireSource">Trouver l'entité questionConstruireSource dans Solr</a>
	 * <br/>
	...
	public static final String questionMkdirServeurH3Span1 = "Après avoir compilé Solr, où puis-je l'installer en tant que serveur? ";
	...
	public static final String questionMkdirServeurH4Span1 = "Créez un répertoire solr dans /srv. ";
	...
	public static final String questionMkdirServeurOl1Li81 = "/srv est un bon endroit pour installer des serveurs logicielles open source telles que Solr qui fonctionnent comme un service. ";
	...
	public static final String questionMkdirServeurOl2Li41 = "/srv/solr/ : Le répertoire où le serveur sera installé.";
	...
	public static final String questionMkdirServeurOl3Li11 = "chmod: Changer les bits de mode de fichier. ";
	public static final String questionMkdirServeurOl3Li1 = questionMkdirServeurOl3Li11;
	public static final String questionMkdirServeurOl3Li21 = "a+x: Donner à tous les utilisateurs des privilèges exécutables sur les fichiers suivants. ";
	public static final String questionMkdirServeurOl3Li2 = questionMkdirServeurOl3Li21;
	public static final String questionMkdirServeurOl3Li31 = "/srv/solr/bin/* : Les binaires Solr à rendre exécutable. ";
	...
	public static final String questionMkdirServeurOl4Li31 = "/srv/solr/example/ : Les fichiers d'exemples Solr générant des messages d’erreur lors du démarrage du serveur s’ils restent là. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionMkdirServeur">Trouver l'entité questionMkdirServeur dans Solr</a>
	 * <br/>
	...
	public static final String questionConfigurerH3Span1 = "Comment puis-je configurer le serveur Solr ? ";
	...
	public static final String questionConfigurerH4Span1 = "Créez un fichier solr.xml. ";
	...
	public static final String questionConfigurerOl2Li081 = "/srv/solr/solr.xml : Un nouveau fichier de configuration pour Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionConfigurer">Trouver l'entité questionConfigurer dans Solr</a>
	 * <br/>
	...
	public static final String questionConfigurerConfigsetH3Span1 = "Comment créer un configset Solr pour mon site ? ";
	...
	public static final String questionConfigurerConfigsetOl1Li04Span31 = " : Le répertoire pour le configset Solr computate. ";
	...
	public static final String questionConfigurerConfigsetOl2Li071 = "config/solr/server/solr/configsets/computate : Mon configset préféré à utiliser dans Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionConfigurerConfigset">Trouver l'entité questionConfigurerConfigset dans Solr</a>
	 * <br/>
	...
	public static final String questionConfigsetZookeeperH3Span1 = "Comment télécharger mon configset Solr sur Zookeeper ? ";
	...
	public static final String questionConfigsetZookeeperH4Span1 = "Utilisez la commande solr zk upconfig. ";
	...
	public static final String questionConfigsetZookeeperOl1Li011 = "/srv/solr/bin/solr : Le binaire exécutable solr. ";
	public static final String questionConfigsetZookeeperOl1Li01 = questionConfigsetZookeeperOl1Li011;
	public static final String questionConfigsetZookeeperOl1Li021 = "zk : Effectuez une opération zookeeper avec les configsets Solr. ";
	public static final String questionConfigsetZookeeperOl1Li02 = questionConfigsetZookeeperOl1Li021;
	public static final String questionConfigsetZookeeperOl1Li031 = "upconfig : Téléchargez un configset Solr sur zookeeper. ";
	...
	public static final String questionConfigsetZookeeperOl1Li04Span31 = " : Le nom du configset Solr. ";
	...
	public static final String questionConfigsetZookeeperOl1Li05Span31 = " : Le chemin vers le configset Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionConfigsetZookeeper">Trouver l'entité questionConfigsetZookeeper dans Solr</a>
	 * <br/>
	...
	public static final String questionServiceH3Span1 = "Comment puis-je exécuter Solr tout le temps au démarrage de mon ordinateur ? ";
	...
	public static final String questionServiceH4Span1 = "Comment exécuter Solr en tant que service systemd. ";
	...
	public static final String questionServiceOl2Li041 = "After=... : Le service Solr sera démarré après les dépendances suivantes. ";
	...
	public static final String questionServiceOl2Li091 = "ExecStart=... : La commande Solr qui lancera le service. ";
	...
	public static final String questionServiceOl2Li161 = "/usr/lib/systemd/system/solr.service : Un nouveau fichier de service systemd dans lequel écrire pour Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionService">Trouver l'entité questionService dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSystemctlDaemonReload">Trouver l'entité questionSystemctlDaemonReload dans Solr</a>
	 * <br/>
	...
	public static final String questionSystemctlEnableH3Span1 = "Comment activer le service Solr? ";
	...
	public static final String questionSystemctlEnableOl2Li41 = "solr : Activez le service Solr pour démarrer au démarrage de l'ordinateur. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSystemctlEnable">Trouver l'entité questionSystemctlEnable dans Solr</a>
	 * <br/>
	...
	public static final String questionSystemctlStartH3Span1 = "Comment démarrer le service Solr? ";
	...
	public static final String questionSystemctlStartOl2Li41 = "solr : Démarrez le service Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSystemctlStart">Trouver l'entité questionSystemctlStart dans Solr</a>
	 * <br/>
	...
	public static final String questionSystemctlStatusH3Span1 = "Comment puis-je m'assurer que le service Solr a démarré avec succès ? ";
	...
	public static final String questionSystemctlStatusOl2Li41 = "solr : Vérifiez le statut du service Solr. ";
	public static final String questionSystemctlStatusOl2Li4 = questionSystemctlStatusOl2Li41;
	public static final String questionSystemctlStatusP21 = "Et comme ça, votre serveur Solr est prêt pour que le client se connecte et commence à mettre en cluster. ";
	public static final String questionSystemctlStatusP22 = "Dans les leçons suivants, nous allons connecter un moteur de recherche ainsi que vos applications Web à Solr pour leur mettre en cluster. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSystemctlStatus">Trouver l'entité questionSystemctlStatus dans Solr</a>
	 * <br/>
	...
	public static final String questionCollectionsSolrH3Span1 = "Comment créer des collections Solr pour commencer l'indexation et la recherche de mon contenu ? ";
	...
	public static final String questionCollectionsSolrH4Span1 = "Créez des collections avec la commande solr. ";
	...
	public static final String questionCollectionsSolrOl1Li021 = "create_collection : Effectuez une opération zookeeper avec les configsets Solr. ";
	...
	public static final String questionCollectionsSolrOl1Li03Span31 = " : Le nom de la collection Solr à créer. ";
	...
	public static final String questionCollectionsSolrOl1Li04Span31 = " : Le nom de la collection Solr à créer. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionCollectionsSolr">Trouver l'entité questionCollectionsSolr dans Solr</a>
	 * <br/>
	...
	public static final String questionLiensH3Span1 = "Où puis-je aller une fois que j'ai installé un serveur Solr ? ";
	...
	public static final String questionLiensH4Span1 = "Voici quelques URLs utiles vers votre serveur Solr. ";
	...
	public static final String questionLiensUlLi1Span1 = "Le lien vers le tableau de bord Solr, pour des informations sur votre serveur Solr en cours d'exécution. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionLiens">Trouver l'entité questionLiens dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:recapituler1">Trouver l'entité recapituler1 dans Solr</a>
	 * <br/>
	...
	public static final String recapituler2TableTr2Td31 = "Installer Solr à partir du code source. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:recapituler2">Trouver l'entité recapituler2 dans Solr</a>
	 * <br/>
	...
	public static final String recapituler3TableTr02Td21 = "Comment installer les dépendences pour Solr ? ";
	...
	public static final String recapituler3TableTr03Td21 = "Où est-ce que je place le code source Solr ? ";
	...
	public static final String recapituler3TableTr03Td41 = "Créez un répertoire solr dans /usr/local/src. ";
	...
	public static final String recapituler3TableTr04Td21 = "Comment télécharger le code source de Solr ? ";
	...
	public static final String recapituler3TableTr05Td21 = "Comment contruire le code source de Solr ? ";
	...
	public static final String recapituler3TableTr05Td41 = "Construisez Solr avec la commande ant. ";
	...
	public static final String recapituler3TableTr08Td21 = "Après avoir compilé Solr, où puis-je l'installer en tant que serveur? ";
	...
	public static final String recapituler3TableTr08Td41 = "Créez un répertoire solr dans /srv. ";
	...
	public static final String recapituler3TableTr09Td21 = "Comment puis-je configurer le serveur Solr ? ";
	...
	public static final String recapituler3TableTr09Td41 = "Créez un fichier solr.xml. ";
	...
	public static final String recapituler3TableTr10Td21 = "Comment créer un configset Solr pour mon site ? ";
	...
	public static final String recapituler3TableTr11Td21 = "Comment télécharger mon configset Solr sur Zookeeper ? ";
	...
	public static final String recapituler3TableTr11Td41 = "Utilisez la commande solr zk upconfig. ";
	...
	public static final String recapituler3TableTr12Td21 = "Comment puis-je exécuter Solr tout le temps au démarrage de mon ordinateur ? ";
	...
	public static final String recapituler3TableTr12Td41 = "Comment exécuter Solr en tant que service systemd. ";
	...
	public static final String recapituler3TableTr14Td21 = "Comment activer le service Solr? ";
	...
	public static final String recapituler3TableTr15Td21 = "Comment démarrer le service Solr? ";
	...
	public static final String recapituler3TableTr16Td21 = "Comment puis-je m'assurer que le service Solr a démarré avec succès ? ";
	...
	public static final String recapituler3TableTr17Td21 = "Comment créer des collections Solr pour commencer l'indexation et la recherche de mon contenu ? ";
	...
	public static final String recapituler3TableTr17Td41 = "Créez des collections avec la commande solr. ";
	...
	public static final String recapituler3TableTr18Td21 = "Où puis-je aller une fois que j'ai installé un serveur Solr ? ";
	...
	public static final String recapituler3TableTr18Td41 = "Voici quelques URLs utiles vers votre serveur Solr. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:recapituler3">Trouver l'entité recapituler3 dans Solr</a>
	 * <br/>
	...
	public C001L010InstallerSolr initLoinC001L010InstallerSolr(RequeteSiteFrFR requeteSite_) {
	...
	public void requeteSiteC001L010InstallerSolr(RequeteSiteFrFR requeteSite_) {
	...
	public static void indexer() {
		try {
			...
			rechercheSolr.addFilterQuery("id:" + ClientUtils.escapeQueryChars("org.computate.site.frFR.cours.c001.l010.C001L010InstallerSolr"));
