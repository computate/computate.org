...
public abstract class C001L006InstallerEclipseGen<DEV> extends C001Lecon {
	...
	public static final String C001L006InstallerEclipse_Titre = "Comment installer des outils de développement pour développer mon site web ? Comment installer l'IDE Eclipse de manière open source. ";
	...
	public static final String moiP2 = "Pour montrer à quel point Eclipse est important pour le monde du développement open source, de nombreuses grandes entreprises de technologie ont leurs propres IDE basés sur Eclipse. ";
	public static final String moiP3 = "Notamment Red Hat, IBM, Texas Instruments, Adobe, Node, PHP et bien d'autres.";
	public static final String moiP4 = "Red Hat® Developer Studio est un environnement de développement intégré (IDE) certifié basé sur Eclipse, qui permet de développer, tester et déployer des applications Web élaborées, des applications Web mobiles, des applications transactionnelles d'entreprise et des microservices. ";
	public static final String moiP5 = "Fidèle à la mission de Red Hat, « aider les entreprises à relever les défis auxquels elles sont confrontées de manière open source, » Red Hat est très impliqué dans Eclipse. ";
	public static final String moiP6 = "Je vous aiderai à installer la version la plus récente d'Eclipse pour développer votre site Web de manière open source. ";
	...
	public static final String questionDependencesH3Span1 = "Comment installer les dépendences pour Eclipse ? ";
	...
	public static final String questionDependencesOl2Li21 = "Ce qui signifie \"Yellowdog Updater Modified\", mais personne ne le connait comme yellowdog, juste yum. ";
	...
	public static final String questionDependencesOl2Li41 = "git : Les noms du paquet que vous souhaitez installer. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionDependences">Trouver l'entité questionDependences dans Solr</a>
	 * <br/>
	...
	public static final String questionMkdirSrcH3Span1 = "Où est-ce que je place le code source Eclipse ? ";
	...
	public static final String questionMkdirSrcH4Span1 = "Créez un répertoire eclipse dans /usr/local/src. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionMkdirSrc">Trouver l'entité questionMkdirSrc dans Solr</a>
	 * <br/>
	...
	public static final String questionMkdirEclipseH3Span1 = "Où puis-je installer Eclipse ? ";
	...
	public static final String questionMkdirEclipseH4Span1 = "Créez un répertoire eclipse dans /opt. ";
	...
	public static final String questionMkdirEclipseOl2Li81 = "/opt est un bon endroit pour installer des applications logicielles open source telles que Eclipse. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionMkdirEclipse">Trouver l'entité questionMkdirEclipse dans Solr</a>
	 * <br/>
	...
	public static final String questionClonerSourceH3Span1 = "Comment télécharger le code source d'Eclipse ? ";
	...
	public static final String questionClonerSourceOl2Li31 = "git://git.eclipse.org/gitroot/platform/eclipse.platform.releng.aggregator.git : URL git vers le référentiel de code source eclipse. ";
	public static final String questionClonerSourceOl2Li3 = questionClonerSourceOl2Li31;
	public static final String questionClonerSourceOl2Li41 = "/usr/local/src/eclipse : Répertoire dans lequel le code source eclipse sera cloné. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionClonerSource">Trouver l'entité questionClonerSource dans Solr</a>
	 * <br/>
	...
	public static final String questionListerTagsH3Span1 = "Comment choisir une version récente d'Eclipse ? ";
	...
	public static final String questionListerTagsOl1Li11 = "(cd : Changer de répertoire temporairement avec la parenthèse ouverte. ";
	public static final String questionListerTagsOl1Li1 = questionListerTagsOl1Li11;
	public static final String questionListerTagsOl1Li21 = "/usr/local/src/eclipse : Répertoire dans lequel le code source eclipse a été cloné. ";
	public static final String questionListerTagsOl1Li2 = questionListerTagsOl1Li21;
	public static final String questionListerTagsOl1Li31 = "&& : Exécutez la commande cd et git ensemble. ";
	...
	public static final String questionListerTagsOl1Li51 = "tag) : Répertorie les tags actuelles ou les versions assignées du code et ferme la parenthèse. ";
	public static final String questionListerTagsOl1Li5 = questionListerTagsOl1Li51;
	public static final String questionListerTagsP1Span11 = "Choisir une version peut être assez déroutant, je vous recommande de visiter la page Eclipse Project Build Types. ";
	...
	public static final String questionListerTagsP1Span31 = ". Vous trouverez des informations sur les versions stables: « Les versions stables sont des versions d'intégration qui se sont révélées suffisamment stables pour être utilisées par la plupart des utilisateurs. ";
	public static final String questionListerTagsP1Span32 = "Ils sont promus d’intégration en construction stable par l’équipe d’architectes après avoir été utilisés pendant quelques jours et jugés raisonnablement stables. ";
	public static final String questionListerTagsP1Span33 = "La dernière version stable est la bonne version pour ceux qui veulent rester au courant de ce qui se passe dans le dernier flux de développement et qui ne craignent pas de rencontrer quelques problèmes pour obtenir les dernières fonctionnalités des corrections. ";
	public static final String questionListerTagsP1Span34 = "La dernière version stable est celle que l’équipe de développement aime bien utiliser, en raison des retours précieux et opportuns. » ";
	public static final String questionListerTagsP1Span35 = "Visitez, alors, la page Eclipse Project Downloads. ";
	public static final String questionListerTagsP1Span3 = questionListerTagsP1Span31 + questionListerTagsP1Span32 + questionListerTagsP1Span33 + questionListerTagsP1Span34 + questionListerTagsP1Span35;
	...
	public static final String questionListerTagsP2Span21 = ". Recherchez la section « Stable Builds ». ";
	public static final String questionListerTagsP2Span22 = "Si elle indique quelque chose comme \"4.12M1\", recherchez le tag git \"S4_12_0_M1\" qui serait probablement le bon tag stable sur laquelle on peut construire à ce moment-là. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionListerTags">Trouver l'entité questionListerTags dans Solr</a>
	 * <br/>
	...
	public static final String questionCheckoutTagH3Span1 = "Comment changer de version du code source d'Eclipse ? ";
	...
	public static final String questionCheckoutTagOl1Li51 = "checkout : Checkout une branche dans l’arbre de travail. ";
	public static final String questionCheckoutTagOl1Li5 = questionCheckoutTagOl1Li51;
	public static final String questionCheckoutTagOl1Li61 = "S4_12_0_M1) : La dernière tag pour baser la branche. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionCheckoutTag">Trouver l'entité questionCheckoutTag dans Solr</a>
	 * <br/>
	...
	public static final String questionSousModulesH3Span1 = "Comment puis-je intégrer toutes les dépendances d'Eclipse ? ";
	...
	public static final String questionSousModulesH4Span1 = "Mettez à jour les sous-modules avec git. ";
	...
	public static final String questionSousModulesOl2Li51 = "submodule : Les sous-modules Git sont d'autres référentiels Git qui peuvent être chargés dans un autre référentiel à un certain commit. ";
	public static final String questionSousModulesOl2Li5 = questionSousModulesOl2Li51;
	public static final String questionSousModulesOl2Li61 = "update : Mettez à jour tous les sous-modules dans le référentiel git actuel. ";
	public static final String questionSousModulesOl2Li6 = questionSousModulesOl2Li61;
	public static final String questionSousModulesOl2Li71 = "--init : Initialise les sous-modules vides. ";
	public static final String questionSousModulesOl2Li7 = questionSousModulesOl2Li71;
	public static final String questionSousModulesOl2Li81 = "--recursive) : Initialiser les sous-modules des sous-modules dans le référentiel git de manière récursive. ";
	public static final String questionSousModulesOl2Li82 = "Cela prendra beaucoup de temps. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSousModules">Trouver l'entité questionSousModules dans Solr</a>
	 * <br/>
	...
	public static final String questionConstruireSourceH3Span1 = "Comment contruire le code source d'eclipse ? ";
	...
	public static final String questionConstruireSourceH4Span1 = "Construisez Eclipse avec la commande mvn. ";
	...
	public static final String questionConstruireSourceOl1Li51 = "clean : Nettoyez toutes les versions précédentes. ";
	public static final String questionConstruireSourceOl1Li5 = questionConstruireSourceOl1Li51;
	public static final String questionConstruireSourceOl1Li61 = "verify : La cible Maven pour construire l’application Eclipse. ";
	public static final String questionConstruireSourceOl1Li6 = questionConstruireSourceOl1Li61;
	public static final String questionConstruireSourceOl1Li71 = "-DskipTests=true) : Ignorer les tests pour accélérer la compilation, mais la compilation prendra encore beaucoup de temps. ";
	public static final String questionConstruireSourceOl1Li7 = questionConstruireSourceOl1Li71;
	public static final String questionConstruireSourceP21 = "Maintenant, copiez la nouvelle application Eclipse dans le répertoire de destination. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionConstruireSource">Trouver l'entité questionConstruireSource dans Solr</a>
	 * <br/>
	...
	public static final String questionErreurH3Span1 = "Et si ma construction échoue ? ";
	...
	public static final String questionErreurH4Span1 = "Essayez une autre tag, nettoyez-la et réessayez. ";
	...
	public static final String questionErreurOl3Li061 = "foreach : Exécutez la commande suivante pour chaque sous-module. ";
	...
	public static final String questionErreurOl3Li091 = "clean : Supprimer les fichiers non suivis de l'arbre de travail. ";
	public static final String questionErreurOl3Li09 = questionErreurOl3Li091;
	public static final String questionErreurOl3Li101 = "-f : Force git à nettoyer le projet. ";
	public static final String questionErreurOl3Li10 = questionErreurOl3Li101;
	public static final String questionErreurOl3Li111 = "-d) : Supprimez les répertoires non suivis en plus des fichiers non suivis. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionErreur">Trouver l'entité questionErreur dans Solr</a>
	 * <br/>
	...
	public static final String questionCopierSourceH3Span1 = "Comment pourrais-je copier la nouvelle version d'Eclipse au bon endroit ? ";
	...
	public static final String questionCopierSourceH4Span1 = "Utilisez rsync. ";
	...
	public static final String questionCopierSourceOl2Li11 = "rsync: Un outil de copie de fichiers rapide et polyvalent, distant (et local). ";
	public static final String questionCopierSourceOl2Li1 = questionCopierSourceOl2Li11;
	public static final String questionCopierSourceOl2Li21 = "-r: Recurse dans des répertoires. ";
	public static final String questionCopierSourceOl2Li2 = questionCopierSourceOl2Li21;
	public static final String questionCopierSourceOl2Li31 = "Le répertoire où l'application eclipse a été construite. ";
	public static final String questionCopierSourceOl2Li32 = "N'oubliez pas le slash à la fin ou rsync suppose qu'il s'agit d'un fichier dans la destination. ";
	public static final String questionCopierSourceOl2Li3 = questionCopierSourceOl2Li31 + questionCopierSourceOl2Li32;
	public static final String questionCopierSourceOl2Li41 = "/opt/eclipse/ : Le répertoire où le eclipse sera installé.";
	public static final String questionCopierSourceOl2Li42 = "/opt/eclipse/ : C'est préférable de toujours écrire des répertoires avec un slash dans rsync pour éviter les surprises. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionCopierSource">Trouver l'entité questionCopierSource dans Solr</a>
	 * <br/>
	...
	public static final String questionSauvegardeRemplacerH3Span1 = "Comment créer une icône d'application pour exécuter eclipse ? ";
	...
	public static final String questionSauvegardeRemplacerH4Span1 = "Créez un fichier eclipse.desktop dans /usr/share/applications. ";
	...
	public static final String questionSauvegardeRemplacerPre1Span06Br1 = "Comment=Environnement de Développement Intégré Eclipse";
	...
	public static final String questionSauvegardeRemplacerP11 = "Comme ça, vous pouvez maintenant trouver Eclipse dans vos applications ! ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.cours.c001.l006.C001L006InstallerEclipse&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:questionSauvegardeRemplacer">Trouver l'entité questionSauvegardeRemplacer dans Solr</a>
	 * <br/>
	...
	public static final String recapituler2TableTr2Td11 = "9 Mai 2019";
	public static final String recapituler2TableTr2Td1 = recapituler2TableTr2Td11;
	public static final String recapituler2TableTr2Td21 = "Comment installer la dernière version d'Eclipse ? ";
	public static final String recapituler2TableTr2Td2 = recapituler2TableTr2Td21;
	public static final String recapituler2TableTr2Td31 = "Installer eclipse à partir du code source. ";
	...
	public static final String recapituler3TableTr02Td21 = "Comment installer les dépendences pour Eclipse ? ";
	...
	public static final String recapituler3TableTr03Td21 = "Où est-ce que je place le code source Eclipse ? ";
	...
	public static final String recapituler3TableTr03Td41 = "Créez un répertoire eclipse dans /usr/local/src. ";
	...
	public static final String recapituler3TableTr04Td21 = "Où puis-je installer Eclipse ? ";
	...
	public static final String recapituler3TableTr04Td41 = "Créez un répertoire eclipse dans /opt. ";
	...
	public static final String recapituler3TableTr05Td21 = "Comment télécharger le code source d'Eclipse ? ";
	...
	public static final String recapituler3TableTr06Td21 = "Comment choisir une version récente d'Eclipse ? ";
	...
	public static final String recapituler3TableTr07Td21 = "Comment changer de version du code source d'Eclipse ? ";
	...
	public static final String recapituler3TableTr08Td21 = "Comment puis-je intégrer toutes les dépendances d'Eclipse ? ";
	...
	public static final String recapituler3TableTr08Td41 = "Mettez à jour les sous-modules avec git. ";
	...
	public static final String recapituler3TableTr09Td21 = "Comment contruire le code source d'Eclipse ? ";
	...
	public static final String recapituler3TableTr09Td41 = "Construisez Eclipse avec la commande mvn. ";
	...
	public static final String recapituler3TableTr10Td21 = "Et si ma construction échoue ? ";
	...
	public static final String recapituler3TableTr10Td41 = "Essayez une autre tag, nettoyez-la et réessayez. ";
	...
	public static final String recapituler3TableTr11Td21 = "Comment pourrais-je copier la nouvelle version d'Eclipse au bon endroit ? ";
	...
	public static final String recapituler3TableTr11Td41 = "Utilisez rsync. ";
	...
	public static final String recapituler3TableTr12Td21 = "Comment créer une icône d'application pour exécuter eclipse ? ";
	...
	public static final String recapituler3TableTr12Td41 = "Créez un fichier eclipse.desktop dans /usr/share/applications. ";
