...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.page.faq.PageFaq&fq=classeEtendGen_indexed_boolean:true">Trouver la classe i18n dans Solr</a>
 * <br/>
 **/
public abstract class PageFaqGen<DEV> extends Article {
	 ...
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.page.faq.PageFaq&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:pageUri_enUS">Trouver l'entité pageUri_enUS dans Solr</a>
	 * <br/>
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.site.frFR.page.faq.PageFaq&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:pageUri_frFR">Trouver l'entité pageUri_frFR dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	public static final String i18nQuestion1 = "Pourquoi est votre site traduit en français ? ";
	public static final String i18nQuestion = i18nQuestion1;
	public static final String i18nQuestionCourt1 = "Pourquoi est votre site traduit en français ? ";
	public static final String i18nQuestionCourt = i18nQuestionCourt1;
	public static final String i18nReponse1 = "L'internationalisation est importante et le monde mérite la bonne documentation logicielle. ";
	public static final String i18nReponse = i18nReponse1;
	public static final String i18nReponseCourt1 = "L'internationalisation est importante et le monde mérite la bonne documentation logicielle. ";
	public static final String i18nReponseCourt = i18nReponseCourt1;
	public static final String i18nP1 = "L'internationalisation est importante et le monde mérite la bonne documentation logicielle. ";
	public static final String i18nP2 = "J'ai passé quatre ans et demi dans les pays francophones et c'est important pour moi de pratiquer mon français. ";
	public static final String i18nP3 = "J'aime les français et les années que j'ai passé en France, j'aime les Québécois et les années que j'ai passé au Québec. ";
	public static final String i18nP4 = "Je connais les défis à créer de bons systèmes logiciels où le pays parle une autre langue que l'anglais. ";
	public static final String i18nP5 = "Computate.org brise ces barrières et fournit une documentation cohérente en français et en anglais et dans d'autres langues à l'avenir. ";
