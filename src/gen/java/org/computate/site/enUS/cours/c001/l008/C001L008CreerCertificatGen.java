...
public abstract class C001L008CreerCertificatGen<DEV> extends C001Lecon {
	...
	public static final String questionDependencesOl2Li51 = "epel-release: The package name of the Extra Packages for Enterprise Linux repository. ";
	...
	public static final String questionMkdirSrvOl2Li021 = "install: Creates directories and sets attributes on the new directory. ";
	public static final String questionMkdirSrvOl2Li02 = questionMkdirSrvOl2Li021;
	public static final String questionMkdirSrvOl2Li031 = "-d: Create  directories. ";
	public static final String questionMkdirSrvOl2Li03 = questionMkdirSrvOl2Li031;
	public static final String questionMkdirSrvOl2Li041 = "-o: Set ownership on the directory (super-user only). ";
	public static final String questionMkdirSrvOl2Li04 = questionMkdirSrvOl2Li041;
	public static final String questionMkdirSrvOl2Li051 = "$USER: The current user to make the owner of the directory. ";
	public static final String questionMkdirSrvOl2Li05 = questionMkdirSrvOl2Li051;
	public static final String questionMkdirSrvOl2Li061 = "-g: Set group ownership on the directory (super-user only). ";
	public static final String questionMkdirSrvOl2Li06 = questionMkdirSrvOl2Li061;
	public static final String questionMkdirSrvOl2Li071 = "$USER: The current user to make the group owner of the directory. ";
	public static final String questionMkdirSrvOl2Li07 = questionMkdirSrvOl2Li071;
	public static final String questionMkdirSrvOl2Li081 = "-m: Set group ownership on the directory (super-user only). ";
	public static final String questionMkdirSrvOl2Li08 = questionMkdirSrvOl2Li081;
	public static final String questionMkdirSrvOl2Li091 = "700: Give read, write and execute permissions to only the user of the directory. ";
	public static final String questionMkdirSrvOl2Li09 = questionMkdirSrvOl2Li091;
	public static final String questionMkdirSrvOl2Li101 = "/srv is a good place to install open source software serveurs and your certificates, keys and keystores. ";
	...
	public static final String questionCertbot1H3Span1 = "How do I obtain my certificate? ";
	...
	public static final String questionCertbot1H4Span1 = "Use the certbot command. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.cours.c001.l008.C001L008CreerCertificat&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:questionCertbot1">Trouver l'entité questionCertbot1 dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.cours.c001.l008.C001L008CreerCertificat&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:questionCertbot2">Trouver l'entité questionCertbot2 dans Solr</a>
	 * <br/>
	...
	public static final String questionCertbot3Ol2Li021 = "certbot: A free, automated certificate authority that aims to lower the barriers to entry for encrypting all HTTP traffic on the Internet. ";
	public static final String questionCertbot3Ol2Li02 = questionCertbot3Ol2Li021;
	public static final String questionCertbot3Ol2Li031 = "--manual: Obtain certificates interactively, or using shell script. ";
	public static final String questionCertbot3Ol2Li03 = questionCertbot3Ol2Li031;
	public static final String questionCertbot3Ol2Li041 = "--preferred-challenges dns: Obtain or renew a certificate, but do not install it. ";
	public static final String questionCertbot3Ol2Li04 = questionCertbot3Ol2Li041;
	public static final String questionCertbot3Ol2Li051 = "--server https://acme-v02.api.letsencrypt.org/directory: Specify a more recent version of a letsencrypt server that allows wildcard domains in certificates. ";
	public static final String questionCertbot3Ol2Li05 = questionCertbot3Ol2Li051;
	public static final String questionCertbot3Ol2Li061 = "certonly: Obtain or renew a certificate, but do not install it. ";
	public static final String questionCertbot3Ol2Li06 = questionCertbot3Ol2Li061;
	public static final String questionCertbot3Ol2Li071 = "-d example.com: Specify your root domain name to include it as a route secured by the certificate. ";
	public static final String questionCertbot3Ol2Li07 = questionCertbot3Ol2Li071;
	public static final String questionCertbot3Ol2Li081 = "-d example.com: Include wildcard domains under your root domain, which would include www for example. ";
	public static final String questionCertbot3Ol2Li08 = questionCertbot3Ol2Li081;
	public static final String questionCertbot3Ol2Li091 = "-d example.com: Wildcard domains do not include subdomains of a wildcard domain, so include additional subdomains as well. ";
	public static final String questionCertbot3Ol2Li09 = questionCertbot3Ol2Li091;
	public static final String questionCertbot3Ol2Li101 = "-d example.com: You can optionally include more than one domain name in the same certificate if you want to, up to a generous amount by letsencrypt. ";
	public static final String questionCertbot3Ol2Li10 = questionCertbot3Ol2Li101;
	public static final String questionCertbot3P21 = "certbot will ask you questions, like if you're okay having your IP address logged as having requested this certificate. ";
	public static final String questionCertbot3P22 = "You can answer Yes, because it is your certificate. ";
	public static final String questionCertbot3P23 = "It will probably ask you for your email, which is nice, because they will send you an email when your certificate is a few weeks from expiring. ";
	public static final String questionCertbot3P24 = "The certificates expire every 3 months, which is often, but they are free, so you can't complain too much. ";
	public static final String questionCertbot3P25 = "Much more expensive certificates might last for 3 years. ";
	...
	public static final String questionCertbot3P3Span11 = "Also, certbot will ask you to create several TXT DNS records with random values for your domain names you specified to prove that you own the domain. ";
	public static final String questionCertbot3P3Span12 = "This will take some time to do every 3 months, so I recommend a service that will let you manage the DNS of your own domain names. ";
	public static final String questionCertbot3P3Span13 = "Fastmail is the service that I use for both personal email and DNS ";
	...
	public static final String questionCertbot3P3Span21 = ". Fastmail is Australia based, and they protect your email privacy, unlike some other email providers. ";
	public static final String questionCertbot3P3Span22 = "With Fastmail, I can login, even from my Fastmail phone app, and manage my DNS. ";
	public static final String questionCertbot3P3Span23 = "I can manage as many domain names as I want with Fastmail. ";
	public static final String questionCertbot3P3Span24 = "I just tell the support team of the domain registrar where I purchased the domain, the name servers of fastmail.com (ns1.messagingengine.com, ns2.messagingengine.com) and add the domain in Fastmail. ";
	public static final String questionCertbot3P3Span25 = "Then I can manage the DNS records, after the changes are made for all my domains. ";
	public static final String questionCertbot3P3Span26 = "So I add a TXT record and value for each certbot challenge and save the changes. ";
	public static final String questionCertbot3P3Span27 = "As far as I can tell, the TXT records are recorded immediately. ";
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut PageHtml(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.cours.c001.l008.C001L008CreerCertificat&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:questionCertbot3">Trouver l'entité questionCertbot3 dans Solr</a>
	 * <br/>
