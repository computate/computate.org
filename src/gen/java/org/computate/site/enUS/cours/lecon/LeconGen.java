package org.computate.site.enUS.cours.lecon;
...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.site.enUS.cours.lecon.Lecon&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class LeconGen<DEV> extends Cluster {
	...
	public Lecon initLoinLecon(RequeteSiteEnUS requeteSite_) {
	...
	public void requeteSiteLecon(RequeteSiteEnUS requeteSite_) {
