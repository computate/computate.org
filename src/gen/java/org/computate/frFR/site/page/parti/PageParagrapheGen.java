...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.frFR.site.page.parti.PageParagraphe&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class PageParagrapheGen<DEV> extends PagePart {
	...
	/**	<br/>L'entité « texte »
	 * Il est construit avant d'être initialisé avec le constructeur par défaut Chaine(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.frFR.site.page.parti.PageParagraphe&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:texte">Trouver l'entité texte dans Solr</a>
	 * <br/>
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut Chaine(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.frFR.site.page.parti.PageParagraphe&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_frFR_indexed_string:texteCourt">Trouver l'entité texteCourt dans Solr</a>
	 * <br/>
