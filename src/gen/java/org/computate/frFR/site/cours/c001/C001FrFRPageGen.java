...
import org.computate.frFR.site.cours.c001.C001FrFRGenPage;
...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.frFR.site.cours.c001.C001FrFRPage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class C001FrFRPageGen<DEV> extends C001FrFRGenPage {
	...
	public C001FrFRPage initLoinC001FrFRPage(RequeteSite requeteSite_) {
	...
	public void requeteSiteC001FrFRPage(RequeteSite requeteSite_) {
